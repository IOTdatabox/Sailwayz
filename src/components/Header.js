...
const Header = () => {
  ...
  return (
    <div className="relative">
      {/* {/ Header /} */}
      <div className="container max-w-[1440px] px-5 pb-[48px] pt-[20px] mx-auto lg:px-10 xl:px-[63px]">
        <div className="flex items-center justify-between">
          <Link href={"/"} aria-label="redirect to home page">
            <Image
              ...
              height={20}
              loading="lazy"
              className="w-[97.74px] lg:w-[146.61px] h-[16px] lg:h-[24px]"
            />
          </Link>
          ...
          <div className="hidden lg:flex pl-[140px]">
            <ul className="flex items-center gap-3 xl:gap-8">
              <li className="futura-font text-[15px] xl:text-[16px] font-medium text-white leading-[26px] hover:text-primaryBlue">
              ...
              <li className="relative group">
                <Link
                  ...
                  className="futura-font text-[15px] xl:text-[16px] font-medium text-white leading-[26px] hover:text-primaryBlue"
                >
                  CASE STUDIES
                </Link>
      ...
      <div
        className={`fixed top-0 left-0 w-full h-auto bg-midNight z-50 transition-transform duration-300 ease-in-out ${

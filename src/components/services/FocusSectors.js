          ...
          <div className="col-span-6 xl:col-span-9">
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-[12px] sm:gap-[30px] lg:gap-[15px] xl:gap-[30px] mb-[30px] sm:mb-[60px]">
              <div className="cursor-pointer shine-hover">
                <div className="shine rounded-[16px] p-[30px] lg:p-[20px] xl:p-[30px] bg-[url('/img/home/finance-bg.png')] bg-cover bg-no-repeat h-[170px] sm:h-[240px] lg:h-[170px] xl:h-[240px]">
                  <Image
              ...
              <div className="cursor-pointer shine-hover">
                <div className="shine rounded-[16px] p-[30px] lg:p-[20px] xl:p-[30px] bg-[url('/img/home/gov-org-bg.png')] bg-cover bg-no-repeat h-[170px] sm:h-[240px] lg:h-[170px] xl:h-[240px]">
                  <Image
              ...
              <div className="cursor-pointer shine-hover">
                <div className="shine rounded-[16px] p-[30px] lg:p-[20px] xl:p-[30px] bg-[url('/img/home/retail-bg.png')] bg-cover bg-no-repeat h-[170px] sm:h-[240px] lg:h-[170px] xl:h-[240px]">
                  <Image
              ...
              <div className="cursor-pointer shine-hover">
                <div className="shine rounded-[16px] p-[30px] lg:p-[20px] xl:p-[30px] bg-[url('/img/home/connectivity-bg.png')] bg-cover bg-no-repeat h-[170px] sm:h-[240px] lg:h-[170px] xl:h-[240px]">
                  <Image
              ...
              <div className="cursor-pointer shine-hover">
                <div className="shine rounded-[16px] p-[30px] lg:p-[20px] xl:p-[30px] bg-[url('/img/home/law-bg.png')] bg-cover bg-no-repeat h-[170px] sm:h-[240px] lg:h-[170px] xl:h-[240px]">
                  <Image
              ...
              <div className="cursor-pointer shine-hover">
                <div className="shine rounded-[16px] p-[30px] lg:p-[20px] xl:p-[30px] bg-[url('/img/home/manufacturing-bg.png')] bg-cover bg-no-repeat h-[170px] sm:h-[240px] lg:h-[170px] xl:h-[240px]">
                  <Image

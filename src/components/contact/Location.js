    ...
    <div className="w-full bg-white">
      <div className="container max-w-[1440px] px-5 py-[40px] sm:py-[100px] mx-auto lg:px-10 xl:px-[63px]">
        <div className="flex flex-col items-center justify-center mb-[50px]">
          <Image
            src="/img/contact/lets-talk-logo-black.svg"
            alt="Let's talk"
            width={134}
            height={26}
            loading="lazy"
            className="hidden sm:block w-[134.47px] h-[26px] mb-[10px]"
          />
          <Image
            src="/img/contact/lets-talk-logo-black-small.svg"
            alt="Let's talk"
            width={101}
            height={22}
            loading="lazy"
            className="block sm:hidden w-[101.47px] h-[22px] mb-[10px]"
          />
